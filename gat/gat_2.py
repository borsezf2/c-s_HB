...
def main():
    ...
    # load data
    data = Planetoid(root="./dataset/cora/" ,name='Cora')[0]
    evaluator = Evaluator(name="ogbn-arxiv")

    cora_train = th.tensor([x for x in range(1,500)])
    cora_test = th.tensor([x for x in range(500,1000)])
    cora_val = th.tensor([x for x in range(1000,2700)])
